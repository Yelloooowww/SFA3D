...
class Sync_time_monitor {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Sync_time_monitor(null);
  ...
  static datatype() {
    ...
    return 'autoware_msgs/Sync_time_monitor';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Sync_time_monitor(null);
...
module.exports = Sync_time_monitor;
