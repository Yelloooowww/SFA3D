...
class image_obj_ranged {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.obj.forEach((val) => {
      bufferOffset = image_rect_ranged.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new image_obj_ranged(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.obj[i] = image_rect_ranged.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static datatype() {
    ...
    return 'autoware_msgs/image_obj_ranged';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new image_obj_ranged(null);
    ...
    if (msg.obj !== undefined) {
      ...
      for (let i = 0; i < resolved.obj.length; ++i) {
        resolved.obj[i] = image_rect_ranged.Resolve(msg.obj[i]);
      }
    }
    else {
      resolved.obj = []
...
module.exports = image_obj_ranged;
