...
class image_obj {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.obj.forEach((val) => {
      bufferOffset = image_rect.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.obj[i] = image_rect.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static datatype() {
    ...
    return 'autoware_msgs/image_obj';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new image_obj(null);
    ...
    if (msg.obj !== undefined) {
      ...
      for (let i = 0; i < resolved.obj.length; ++i) {
        resolved.obj[i] = image_rect.Resolve(msg.obj[i]);
      }
    }
    else {
      resolved.obj = []
