...
(cl:defmethod cl:initialize-instance :after ((m <ConfigNdtMappingOutput>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigNdtMappingOutput)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigNdtMappingOutput> is deprecated: use autoware_msgs-msg:ConfigNdtMappingOutput instead.")))
...
(cl:defmethod filename-val ((m <ConfigNdtMappingOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:filename-val is deprecated.  Use autoware_msgs-msg:filename instead.")
  (filename m))

(cl:ensure-generic-function 'filter_res-val :lambda-list '(m))
(cl:defmethod filter_res-val ((m <ConfigNdtMappingOutput>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:filter_res-val is deprecated.  Use autoware_msgs-msg:filter_res instead.")
  (filter_res m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigNdtMappingOutput>)))
  ...
  "autoware_msgs/ConfigNdtMappingOutput")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigNdtMappingOutput)))
  "Returns string type for a message object of type 'ConfigNdtMappingOutput"
  "autoware_msgs/ConfigNdtMappingOutput")
