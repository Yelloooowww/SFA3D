...
(cl:defmethod cl:initialize-instance :after ((m <ConfigApproximateNdtMapping>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigApproximateNdtMapping)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigApproximateNdtMapping> is deprecated: use autoware_msgs-msg:ConfigApproximateNdtMapping instead.")))
...
(cl:defmethod resolution-val ((m <ConfigApproximateNdtMapping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:resolution-val is deprecated.  Use autoware_msgs-msg:resolution instead.")
  (resolution m))

(cl:ensure-generic-function 'step_size-val :lambda-list '(m))
(cl:defmethod step_size-val ((m <ConfigApproximateNdtMapping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:step_size-val is deprecated.  Use autoware_msgs-msg:step_size instead.")
  (step_size m))

(cl:ensure-generic-function 'trans_epsilon-val :lambda-list '(m))
(cl:defmethod trans_epsilon-val ((m <ConfigApproximateNdtMapping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:trans_epsilon-val is deprecated.  Use autoware_msgs-msg:trans_epsilon instead.")
  (trans_epsilon m))

(cl:ensure-generic-function 'max_iterations-val :lambda-list '(m))
(cl:defmethod max_iterations-val ((m <ConfigApproximateNdtMapping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:max_iterations-val is deprecated.  Use autoware_msgs-msg:max_iterations instead.")
  (max_iterations m))

(cl:ensure-generic-function 'leaf_size-val :lambda-list '(m))
(cl:defmethod leaf_size-val ((m <ConfigApproximateNdtMapping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:leaf_size-val is deprecated.  Use autoware_msgs-msg:leaf_size instead.")
  (leaf_size m))

(cl:ensure-generic-function 'min_scan_range-val :lambda-list '(m))
(cl:defmethod min_scan_range-val ((m <ConfigApproximateNdtMapping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:min_scan_range-val is deprecated.  Use autoware_msgs-msg:min_scan_range instead.")
  (min_scan_range m))

(cl:ensure-generic-function 'max_scan_range-val :lambda-list '(m))
(cl:defmethod max_scan_range-val ((m <ConfigApproximateNdtMapping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:max_scan_range-val is deprecated.  Use autoware_msgs-msg:max_scan_range instead.")
  (max_scan_range m))
...
(cl:defmethod min_add_scan_shift-val ((m <ConfigApproximateNdtMapping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:min_add_scan_shift-val is deprecated.  Use autoware_msgs-msg:min_add_scan_shift instead.")
...
(cl:defmethod max_submap_size-val ((m <ConfigApproximateNdtMapping>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:max_submap_size-val is deprecated.  Use autoware_msgs-msg:max_submap_size instead.")
  (max_submap_size m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigApproximateNdtMapping>)))
  ...
  "autoware_msgs/ConfigApproximateNdtMapping")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigApproximateNdtMapping)))
  "Returns string type for a message object of type 'ConfigApproximateNdtMapping"
  "autoware_msgs/ConfigApproximateNdtMapping")
