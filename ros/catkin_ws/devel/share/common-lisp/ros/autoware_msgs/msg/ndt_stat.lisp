...
(cl:defclass <ndt_stat> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass ndt_stat (<ndt_stat>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ndt_stat>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ndt_stat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ndt_stat> is deprecated: use autoware_msgs-msg:ndt_stat instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ndt_stat>))
...
(cl:defmethod exe_time-val ((m <ndt_stat>))
...
(cl:defmethod iteration-val ((m <ndt_stat>))
...
(cl:defmethod score-val ((m <ndt_stat>))
...
(cl:defmethod velocity-val ((m <ndt_stat>))
...
(cl:defmethod acceleration-val ((m <ndt_stat>))
...
(cl:defmethod use_predict_pose-val ((m <ndt_stat>))
  ...
  (use_predict_pose m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ndt_stat>) ostream)
  "Serializes a message object of type '<ndt_stat>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ndt_stat>) istream)
  "Deserializes a message object of type '<ndt_stat>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ndt_stat>)))
  "Returns string type for a message object of type '<ndt_stat>"
  "autoware_msgs/ndt_stat")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ndt_stat)))
  "Returns string type for a message object of type 'ndt_stat"
  "autoware_msgs/ndt_stat")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ndt_stat>)))
  "Returns md5sum for a message object of type '<ndt_stat>"
  "3c701a222db65bce735c83faea43bd03")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ndt_stat)))
  "Returns md5sum for a message object of type 'ndt_stat"
  "3c701a222db65bce735c83faea43bd03")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ndt_stat>)))
  "Returns full string definition for message of type '<ndt_stat>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ndt_stat)))
  "Returns full string definition for message of type 'ndt_stat"
  (cl:format cl:nil "Header header~%float32 exe_time~%int32 iteration~%float32 score~%float32 velocity~%float32 acceleration~%int32 use_predict_pose~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ndt_stat>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ndt_stat>))
