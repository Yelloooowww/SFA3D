...
(cl:defmethod cl:initialize-instance :after ((m <ConfigPedestrianDpm>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigPedestrianDpm)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigPedestrianDpm> is deprecated: use autoware_msgs-msg:ConfigPedestrianDpm instead.")))
...
(cl:defmethod score_threshold-val ((m <ConfigPedestrianDpm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:score_threshold-val is deprecated.  Use autoware_msgs-msg:score_threshold instead.")
  (score_threshold m))

(cl:ensure-generic-function 'group_threshold-val :lambda-list '(m))
(cl:defmethod group_threshold-val ((m <ConfigPedestrianDpm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:group_threshold-val is deprecated.  Use autoware_msgs-msg:group_threshold instead.")
  (group_threshold m))

(cl:ensure-generic-function 'Lambda-val :lambda-list '(m))
(cl:defmethod Lambda-val ((m <ConfigPedestrianDpm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:Lambda-val is deprecated.  Use autoware_msgs-msg:Lambda instead.")
  (Lambda m))

(cl:ensure-generic-function 'num_cells-val :lambda-list '(m))
(cl:defmethod num_cells-val ((m <ConfigPedestrianDpm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:num_cells-val is deprecated.  Use autoware_msgs-msg:num_cells instead.")
  (num_cells m))

(cl:ensure-generic-function 'num_bins-val :lambda-list '(m))
(cl:defmethod num_bins-val ((m <ConfigPedestrianDpm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:num_bins-val is deprecated.  Use autoware_msgs-msg:num_bins instead.")
  (num_bins m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigPedestrianDpm>)))
  ...
  "autoware_msgs/ConfigPedestrianDpm")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigPedestrianDpm)))
  "Returns string type for a message object of type 'ConfigPedestrianDpm"
  "autoware_msgs/ConfigPedestrianDpm")
