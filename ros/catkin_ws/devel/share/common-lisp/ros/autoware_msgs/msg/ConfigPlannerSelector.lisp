...
(cl:defmethod cl:initialize-instance :after ((m <ConfigPlannerSelector>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigPlannerSelector)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigPlannerSelector> is deprecated: use autoware_msgs-msg:ConfigPlannerSelector instead.")))
...
(cl:defmethod latency_num-val ((m <ConfigPlannerSelector>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:latency_num-val is deprecated.  Use autoware_msgs-msg:latency_num instead.")
  (latency_num m))

(cl:ensure-generic-function 'waypoints_num-val :lambda-list '(m))
(cl:defmethod waypoints_num-val ((m <ConfigPlannerSelector>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:waypoints_num-val is deprecated.  Use autoware_msgs-msg:waypoints_num instead.")
  (waypoints_num m))

(cl:ensure-generic-function 'convergence_num-val :lambda-list '(m))
(cl:defmethod convergence_num-val ((m <ConfigPlannerSelector>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:convergence_num-val is deprecated.  Use autoware_msgs-msg:convergence_num instead.")
  (convergence_num m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigPlannerSelector>)))
  ...
  "autoware_msgs/ConfigPlannerSelector")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigPlannerSelector)))
  "Returns string type for a message object of type 'ConfigPlannerSelector"
  "autoware_msgs/ConfigPlannerSelector")
