...
(cl:defmethod cl:initialize-instance :after ((m <image_obj_ranged>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'image_obj_ranged)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<image_obj_ranged> is deprecated: use autoware_msgs-msg:image_obj_ranged instead.")))
