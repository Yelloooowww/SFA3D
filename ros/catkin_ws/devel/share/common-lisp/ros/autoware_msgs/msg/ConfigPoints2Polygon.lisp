...
(cl:defmethod cl:initialize-instance :after ((m <ConfigPoints2Polygon>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigPoints2Polygon)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigPoints2Polygon> is deprecated: use autoware_msgs-msg:ConfigPoints2Polygon instead.")))
...
(cl:defmethod k_search-val ((m <ConfigPoints2Polygon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:k_search-val is deprecated.  Use autoware_msgs-msg:k_search instead.")
  (k_search m))

(cl:ensure-generic-function 'search_radius-val :lambda-list '(m))
(cl:defmethod search_radius-val ((m <ConfigPoints2Polygon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:search_radius-val is deprecated.  Use autoware_msgs-msg:search_radius instead.")
  (search_radius m))

(cl:ensure-generic-function 'mu-val :lambda-list '(m))
(cl:defmethod mu-val ((m <ConfigPoints2Polygon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:mu-val is deprecated.  Use autoware_msgs-msg:mu instead.")
  (mu m))
...
(cl:defmethod maximum_nearest_neighbors-val ((m <ConfigPoints2Polygon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:maximum_nearest_neighbors-val is deprecated.  Use autoware_msgs-msg:maximum_nearest_neighbors instead.")
...
(cl:defmethod maximum_surface_angle-val ((m <ConfigPoints2Polygon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:maximum_surface_angle-val is deprecated.  Use autoware_msgs-msg:maximum_surface_angle instead.")
...
(cl:defmethod minimum_angle-val ((m <ConfigPoints2Polygon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:minimum_angle-val is deprecated.  Use autoware_msgs-msg:minimum_angle instead.")
  (minimum_angle m))

(cl:ensure-generic-function 'maximum_angle-val :lambda-list '(m))
(cl:defmethod maximum_angle-val ((m <ConfigPoints2Polygon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:maximum_angle-val is deprecated.  Use autoware_msgs-msg:maximum_angle instead.")
  (maximum_angle m))
...
(cl:defmethod normal_consistency-val ((m <ConfigPoints2Polygon>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:normal_consistency-val is deprecated.  Use autoware_msgs-msg:normal_consistency instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigPoints2Polygon>)))
  ...
  "autoware_msgs/ConfigPoints2Polygon")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigPoints2Polygon)))
  "Returns string type for a message object of type 'ConfigPoints2Polygon"
  "autoware_msgs/ConfigPoints2Polygon")
