...
(cl:defclass <vscan_tracked_array> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obj_tracked
    :reader obj_tracked
    :initarg :obj_tracked
    :type (cl:vector autoware_msgs-msg:vscan_tracked)
   :initform (cl:make-array 0 :element-type 'autoware_msgs-msg:vscan_tracked :initial-element (cl:make-instance 'autoware_msgs-msg:vscan_tracked))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <vscan_tracked_array>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'vscan_tracked_array)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<vscan_tracked_array> is deprecated: use autoware_msgs-msg:vscan_tracked_array instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <vscan_tracked_array>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obj_tracked)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'autoware_msgs-msg:vscan_tracked))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<vscan_tracked_array>)))
  ...
  "autoware_msgs/vscan_tracked_array")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'vscan_tracked_array)))
  "Returns string type for a message object of type 'vscan_tracked_array"
  "autoware_msgs/vscan_tracked_array")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<vscan_tracked_array>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%vscan_tracked[] obj_tracked~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: autoware_msgs/vscan_tracked~%geometry_msgs/Point position~%float32 orientation~%float32 velocity~%geometric_rectangle geo_rect~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: autoware_msgs/geometric_rectangle~%float32 wl~%float32 wr~%float32 lf~%float32 lb~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'vscan_tracked_array)))
  "Returns full string definition for message of type 'vscan_tracked_array"
  (cl:format cl:nil "std_msgs/Header header~%vscan_tracked[] obj_tracked~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: autoware_msgs/vscan_tracked~%geometry_msgs/Point position~%float32 orientation~%float32 velocity~%geometric_rectangle geo_rect~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: autoware_msgs/geometric_rectangle~%float32 wl~%float32 wr~%float32 lf~%float32 lb~%~%"))
