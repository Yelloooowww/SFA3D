...
(cl:defmethod cl:initialize-instance :after ((m <ConfigVelocitySet>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigVelocitySet)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigVelocitySet> is deprecated: use autoware_msgs-msg:ConfigVelocitySet instead.")))
...
(cl:defmethod stop_distance_obstacle-val ((m <ConfigVelocitySet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:stop_distance_obstacle-val is deprecated.  Use autoware_msgs-msg:stop_distance_obstacle instead.")
...
(cl:defmethod stop_distance_stopline-val ((m <ConfigVelocitySet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:stop_distance_stopline-val is deprecated.  Use autoware_msgs-msg:stop_distance_stopline instead.")
...
(cl:defmethod detection_range-val ((m <ConfigVelocitySet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:detection_range-val is deprecated.  Use autoware_msgs-msg:detection_range instead.")
  (detection_range m))

(cl:ensure-generic-function 'threshold_points-val :lambda-list '(m))
(cl:defmethod threshold_points-val ((m <ConfigVelocitySet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:threshold_points-val is deprecated.  Use autoware_msgs-msg:threshold_points instead.")
  (threshold_points m))
...
(cl:defmethod detection_height_top-val ((m <ConfigVelocitySet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:detection_height_top-val is deprecated.  Use autoware_msgs-msg:detection_height_top instead.")
...
(cl:defmethod detection_height_bottom-val ((m <ConfigVelocitySet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:detection_height_bottom-val is deprecated.  Use autoware_msgs-msg:detection_height_bottom instead.")
...
(cl:defmethod deceleration_obstacle-val ((m <ConfigVelocitySet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:deceleration_obstacle-val is deprecated.  Use autoware_msgs-msg:deceleration_obstacle instead.")
...
(cl:defmethod deceleration_stopline-val ((m <ConfigVelocitySet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:deceleration_stopline-val is deprecated.  Use autoware_msgs-msg:deceleration_stopline instead.")
...
(cl:defmethod velocity_change_limit-val ((m <ConfigVelocitySet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:velocity_change_limit-val is deprecated.  Use autoware_msgs-msg:velocity_change_limit instead.")
...
(cl:defmethod deceleration_range-val ((m <ConfigVelocitySet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:deceleration_range-val is deprecated.  Use autoware_msgs-msg:deceleration_range instead.")
...
(cl:defmethod temporal_waypoints_size-val ((m <ConfigVelocitySet>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:temporal_waypoints_size-val is deprecated.  Use autoware_msgs-msg:temporal_waypoints_size instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigVelocitySet>)))
  ...
  "autoware_msgs/ConfigVelocitySet")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigVelocitySet)))
  "Returns string type for a message object of type 'ConfigVelocitySet"
  "autoware_msgs/ConfigVelocitySet")
