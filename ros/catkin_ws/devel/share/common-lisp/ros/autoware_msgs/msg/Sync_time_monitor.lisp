...
(cl:defclass <Sync_time_monitor> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass Sync_time_monitor (<Sync_time_monitor>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <Sync_time_monitor>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Sync_time_monitor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<Sync_time_monitor> is deprecated: use autoware_msgs-msg:Sync_time_monitor instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Sync_time_monitor>))
...
(cl:defmethod image_raw-val ((m <Sync_time_monitor>))
...
(cl:defmethod points_raw-val ((m <Sync_time_monitor>))
...
(cl:defmethod points_image-val ((m <Sync_time_monitor>))
...
(cl:defmethod vscan_points-val ((m <Sync_time_monitor>))
...
(cl:defmethod vscan_image-val ((m <Sync_time_monitor>))
...
(cl:defmethod image_obj-val ((m <Sync_time_monitor>))
...
(cl:defmethod image_obj_ranged-val ((m <Sync_time_monitor>))
...
(cl:defmethod image_obj_tracked-val ((m <Sync_time_monitor>))
...
(cl:defmethod current_pose-val ((m <Sync_time_monitor>))
...
(cl:defmethod obj_label-val ((m <Sync_time_monitor>))
...
(cl:defmethod cluster_centroids-val ((m <Sync_time_monitor>))
...
(cl:defmethod obj_pose-val ((m <Sync_time_monitor>))
...
(cl:defmethod execution_time-val ((m <Sync_time_monitor>))
...
(cl:defmethod cycle_time-val ((m <Sync_time_monitor>))
...
(cl:defmethod time_diff-val ((m <Sync_time_monitor>))
  ...
  (time_diff m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Sync_time_monitor>) ostream)
  "Serializes a message object of type '<Sync_time_monitor>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Sync_time_monitor>) istream)
  "Deserializes a message object of type '<Sync_time_monitor>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Sync_time_monitor>)))
  "Returns string type for a message object of type '<Sync_time_monitor>"
  "autoware_msgs/Sync_time_monitor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Sync_time_monitor)))
  "Returns string type for a message object of type 'Sync_time_monitor"
  "autoware_msgs/Sync_time_monitor")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Sync_time_monitor>)))
  "Returns md5sum for a message object of type '<Sync_time_monitor>"
  "8c6a4dd195d4ccc31d38fad617327689")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Sync_time_monitor)))
  "Returns md5sum for a message object of type 'Sync_time_monitor"
  "8c6a4dd195d4ccc31d38fad617327689")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Sync_time_monitor>)))
  "Returns full string definition for message of type '<Sync_time_monitor>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Sync_time_monitor)))
  "Returns full string definition for message of type 'Sync_time_monitor"
  (cl:format cl:nil "Header header~%float64 image_raw~%float64 points_raw~%float64 points_image~%float64 vscan_points~%float64 vscan_image~%float64 image_obj~%float64 image_obj_ranged~%float64 image_obj_tracked~%float64 current_pose~%float64 obj_label~%float64 cluster_centroids~%float64 obj_pose~%float64 execution_time~%float64 cycle_time~%float64 time_diff~%~%~%# time image_raw~%# time points_raw~%# time image_obj~%# time image_obj_ranged~%# time image_obj_tracked~%# time current_pose~%# time obj_label~%# time cluster_centroids~%# time obj_pose~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Sync_time_monitor>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Sync_time_monitor>))
  "Converts a ROS message object to a list"
  (cl:list 'Sync_time_monitor
