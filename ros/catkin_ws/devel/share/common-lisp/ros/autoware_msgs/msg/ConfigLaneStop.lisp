...
(cl:defmethod cl:initialize-instance :after ((m <ConfigLaneStop>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigLaneStop)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigLaneStop> is deprecated: use autoware_msgs-msg:ConfigLaneStop instead.")))
...
(cl:defmethod manual_detection-val ((m <ConfigLaneStop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:manual_detection-val is deprecated.  Use autoware_msgs-msg:manual_detection instead.")
  (manual_detection m))
