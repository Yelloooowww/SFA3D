...
(cl:defmethod cl:initialize-instance :after ((m <ConfigCarDpm>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigCarDpm)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigCarDpm> is deprecated: use autoware_msgs-msg:ConfigCarDpm instead.")))
