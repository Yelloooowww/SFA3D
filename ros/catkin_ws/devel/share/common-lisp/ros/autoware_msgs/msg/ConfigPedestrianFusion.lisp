...
(cl:defmethod cl:initialize-instance :after ((m <ConfigPedestrianFusion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigPedestrianFusion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigPedestrianFusion> is deprecated: use autoware_msgs-msg:ConfigPedestrianFusion instead.")))
...
(cl:defmethod min_low_height-val ((m <ConfigPedestrianFusion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:min_low_height-val is deprecated.  Use autoware_msgs-msg:min_low_height instead.")
  (min_low_height m))

(cl:ensure-generic-function 'max_low_height-val :lambda-list '(m))
(cl:defmethod max_low_height-val ((m <ConfigPedestrianFusion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:max_low_height-val is deprecated.  Use autoware_msgs-msg:max_low_height instead.")
  (max_low_height m))
...
(cl:defmethod min_points-val ((m <ConfigPedestrianFusion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:min_points-val is deprecated.  Use autoware_msgs-msg:min_points instead.")
  (min_points m))

(cl:ensure-generic-function 'dispersion-val :lambda-list '(m))
(cl:defmethod dispersion-val ((m <ConfigPedestrianFusion>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:dispersion-val is deprecated.  Use autoware_msgs-msg:dispersion instead.")
  (dispersion m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigPedestrianFusion>)))
  ...
  "autoware_msgs/ConfigPedestrianFusion")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigPedestrianFusion)))
  "Returns string type for a message object of type 'ConfigPedestrianFusion"
  "autoware_msgs/ConfigPedestrianFusion")
