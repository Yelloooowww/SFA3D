...
(cl:defmethod cl:initialize-instance :after ((m <ConfigDecisionMaker>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigDecisionMaker)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigDecisionMaker> is deprecated: use autoware_msgs-msg:ConfigDecisionMaker instead.")))
...
(cl:defmethod enable_force_state_change-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:enable_force_state_change-val is deprecated.  Use autoware_msgs-msg:enable_force_state_change instead.")
...
(cl:defmethod enable_display_marker-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:enable_display_marker-val is deprecated.  Use autoware_msgs-msg:enable_display_marker instead.")
...
(cl:defmethod convergence_threshold-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:convergence_threshold-val is deprecated.  Use autoware_msgs-msg:convergence_threshold instead.")
...
(cl:defmethod convergence_count-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:convergence_count-val is deprecated.  Use autoware_msgs-msg:convergence_count instead.")
  (convergence_count m))

(cl:ensure-generic-function 'target_waypoint-val :lambda-list '(m))
(cl:defmethod target_waypoint-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:target_waypoint-val is deprecated.  Use autoware_msgs-msg:target_waypoint instead.")
  (target_waypoint m))
...
(cl:defmethod stopline_target_waypoint-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:stopline_target_waypoint-val is deprecated.  Use autoware_msgs-msg:stopline_target_waypoint instead.")
...
(cl:defmethod stopline_target_ratio-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:stopline_target_ratio-val is deprecated.  Use autoware_msgs-msg:stopline_target_ratio instead.")
...
(cl:defmethod shift_width-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:shift_width-val is deprecated.  Use autoware_msgs-msg:shift_width instead.")
  (shift_width m))

(cl:ensure-generic-function 'crawl_velocity-val :lambda-list '(m))
(cl:defmethod crawl_velocity-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:crawl_velocity-val is deprecated.  Use autoware_msgs-msg:crawl_velocity instead.")
  (crawl_velocity m))
...
(cl:defmethod detection_area_rate-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:detection_area_rate-val is deprecated.  Use autoware_msgs-msg:detection_area_rate instead.")
...
(cl:defmethod baselink_tf-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:baselink_tf-val is deprecated.  Use autoware_msgs-msg:baselink_tf instead.")
  (baselink_tf m))

(cl:ensure-generic-function 'detection_area_x1-val :lambda-list '(m))
(cl:defmethod detection_area_x1-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:detection_area_x1-val is deprecated.  Use autoware_msgs-msg:detection_area_x1 instead.")
  (detection_area_x1 m))

(cl:ensure-generic-function 'detection_area_x2-val :lambda-list '(m))
(cl:defmethod detection_area_x2-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:detection_area_x2-val is deprecated.  Use autoware_msgs-msg:detection_area_x2 instead.")
  (detection_area_x2 m))

(cl:ensure-generic-function 'detection_area_y1-val :lambda-list '(m))
(cl:defmethod detection_area_y1-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:detection_area_y1-val is deprecated.  Use autoware_msgs-msg:detection_area_y1 instead.")
  (detection_area_y1 m))

(cl:ensure-generic-function 'detection_area_y2-val :lambda-list '(m))
(cl:defmethod detection_area_y2-val ((m <ConfigDecisionMaker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autoware_msgs-msg:detection_area_y2-val is deprecated.  Use autoware_msgs-msg:detection_area_y2 instead.")
  (detection_area_y2 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ConfigDecisionMaker>)))
  ...
  "autoware_msgs/ConfigDecisionMaker")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ConfigDecisionMaker)))
  "Returns string type for a message object of type 'ConfigDecisionMaker"
  "autoware_msgs/ConfigDecisionMaker")
