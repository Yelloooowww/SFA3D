...
(cl:defmethod cl:initialize-instance :after ((m <ConfigCarFusion>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigCarFusion)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autoware_msgs-msg:<ConfigCarFusion> is deprecated: use autoware_msgs-msg:ConfigCarFusion instead.")))
