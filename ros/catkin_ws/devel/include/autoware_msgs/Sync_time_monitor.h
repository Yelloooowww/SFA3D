// Generated by gencpp from file autoware_msgs/Sync_time_monitor.msg
// DO NOT EDIT!


#ifndef AUTOWARE_MSGS_MESSAGE_SYNC_TIME_MONITOR_H
#define AUTOWARE_MSGS_MESSAGE_SYNC_TIME_MONITOR_H
...
struct Sync_time_monitor_
{
  typedef Sync_time_monitor_<ContainerAllocator> Type;
  ...
  Sync_time_monitor_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , image_raw(0.0)
    , points_raw(0.0)
    , points_image(0.0)
  ...
  typedef boost::shared_ptr< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> const> ConstPtr;

}; // struct Sync_time_monitor_

typedef ::autoware_msgs::Sync_time_monitor_<std::allocator<void> > Sync_time_monitor;

typedef boost::shared_ptr< ::autoware_msgs::Sync_time_monitor > Sync_time_monitorPtr;
typedef boost::shared_ptr< ::autoware_msgs::Sync_time_monitor const> Sync_time_monitorConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::autoware_msgs::Sync_time_monitor_<ContainerAllocator1> & lhs, const ::autoware_msgs::Sync_time_monitor_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> >
{
  ...
  static const char* value(const ::autoware_msgs::Sync_time_monitor_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8c6a4dd195d4ccc3ULL;
  static const uint64_t static_value2 = 0x1d38fad617327689ULL;
};

template<class ContainerAllocator>
struct DataType< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::autoware_msgs::Sync_time_monitor_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_msgs::Sync_time_monitor_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // AUTOWARE_MSGS_MESSAGE_SYNC_TIME_MONITOR_H
