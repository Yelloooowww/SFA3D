...
bool operator==(const ::autoware_msgs::ConfigLatticeVelocitySet_<ContainerAllocator1> & lhs, const ::autoware_msgs::ConfigLatticeVelocitySet_<ContainerAllocator2> & rhs)
{
