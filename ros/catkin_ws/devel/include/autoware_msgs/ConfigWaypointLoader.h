// Generated by gencpp from file autoware_msgs/ConfigWaypointLoader.msg
// DO NOT EDIT!


#ifndef AUTOWARE_MSGS_MESSAGE_CONFIGWAYPOINTLOADER_H
#define AUTOWARE_MSGS_MESSAGE_CONFIGWAYPOINTLOADER_H
...
struct ConfigWaypointLoader_
{
  ...
  typedef boost::shared_ptr< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigWaypointLoader_

typedef ::autoware_msgs::ConfigWaypointLoader_<std::allocator<void> > ConfigWaypointLoader;

typedef boost::shared_ptr< ::autoware_msgs::ConfigWaypointLoader > ConfigWaypointLoaderPtr;
typedef boost::shared_ptr< ::autoware_msgs::ConfigWaypointLoader const> ConfigWaypointLoaderConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator1> & lhs, const ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> >
{
  ...
  static const char* value(const ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x315ec0de44494366ULL;
  static const uint64_t static_value2 = 0xfb427b1b304522e4ULL;
};

template<class ContainerAllocator>
struct DataType< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> >
{
  static const char* value()
  {
    return "autoware_msgs/ConfigWaypointLoader";
  }
...
template<class ContainerAllocator>
struct Definition< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_msgs::ConfigWaypointLoader_<ContainerAllocator>& v)
  {
...
#endif // AUTOWARE_MSGS_MESSAGE_CONFIGWAYPOINTLOADER_H
