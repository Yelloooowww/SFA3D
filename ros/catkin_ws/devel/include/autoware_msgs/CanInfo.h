// Generated by gencpp from file autoware_msgs/CanInfo.msg
// DO NOT EDIT!


#ifndef AUTOWARE_MSGS_MESSAGE_CANINFO_H
#define AUTOWARE_MSGS_MESSAGE_CANINFO_H
...
struct CanInfo_
{
  ...
  typedef boost::shared_ptr< ::autoware_msgs::CanInfo_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autoware_msgs::CanInfo_<ContainerAllocator> const> ConstPtr;

}; // struct CanInfo_

typedef ::autoware_msgs::CanInfo_<std::allocator<void> > CanInfo;

typedef boost::shared_ptr< ::autoware_msgs::CanInfo > CanInfoPtr;
typedef boost::shared_ptr< ::autoware_msgs::CanInfo const> CanInfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::autoware_msgs::CanInfo_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::autoware_msgs::CanInfo_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::autoware_msgs::CanInfo_<ContainerAllocator1> & lhs, const ::autoware_msgs::CanInfo_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::CanInfo_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::CanInfo_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::CanInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::CanInfo_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::CanInfo_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::CanInfo_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::autoware_msgs::CanInfo_<ContainerAllocator> >
{
  ...
  static const char* value(const ::autoware_msgs::CanInfo_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x605f4356821f92a8ULL;
  static const uint64_t static_value2 = 0xfec1a756259316dfULL;
};

template<class ContainerAllocator>
struct DataType< ::autoware_msgs::CanInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::autoware_msgs::CanInfo_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::autoware_msgs::CanInfo_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::autoware_msgs::CanInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_msgs::CanInfo_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // AUTOWARE_MSGS_MESSAGE_CANINFO_H
