// Generated by gencpp from file autoware_msgs/ConfigICP.msg
// DO NOT EDIT!


#ifndef AUTOWARE_MSGS_MESSAGE_CONFIGICP_H
#define AUTOWARE_MSGS_MESSAGE_CONFIGICP_H
...
struct ConfigICP_
{
  ...
  typedef boost::shared_ptr< ::autoware_msgs::ConfigICP_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autoware_msgs::ConfigICP_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigICP_

typedef ::autoware_msgs::ConfigICP_<std::allocator<void> > ConfigICP;

typedef boost::shared_ptr< ::autoware_msgs::ConfigICP > ConfigICPPtr;
typedef boost::shared_ptr< ::autoware_msgs::ConfigICP const> ConfigICPConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::autoware_msgs::ConfigICP_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::autoware_msgs::ConfigICP_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::autoware_msgs::ConfigICP_<ContainerAllocator1> & lhs, const ::autoware_msgs::ConfigICP_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::ConfigICP_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::ConfigICP_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::ConfigICP_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::ConfigICP_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::ConfigICP_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::ConfigICP_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::autoware_msgs::ConfigICP_<ContainerAllocator> >
{
  ...
  static const char* value(const ::autoware_msgs::ConfigICP_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5447e477cc209f1aULL;
  static const uint64_t static_value2 = 0xaba7597ea7741dc8ULL;
};

template<class ContainerAllocator>
struct DataType< ::autoware_msgs::ConfigICP_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::autoware_msgs::ConfigICP_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::autoware_msgs::ConfigICP_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::autoware_msgs::ConfigICP_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_msgs::ConfigICP_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // AUTOWARE_MSGS_MESSAGE_CONFIGICP_H
