// Generated by gencpp from file autoware_msgs/ConfigPedestrianKf.msg
// DO NOT EDIT!


#ifndef AUTOWARE_MSGS_MESSAGE_CONFIGPEDESTRIANKF_H
#define AUTOWARE_MSGS_MESSAGE_CONFIGPEDESTRIANKF_H
...
struct ConfigPedestrianKf_
{
  ...
  typedef boost::shared_ptr< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigPedestrianKf_

typedef ::autoware_msgs::ConfigPedestrianKf_<std::allocator<void> > ConfigPedestrianKf;

typedef boost::shared_ptr< ::autoware_msgs::ConfigPedestrianKf > ConfigPedestrianKfPtr;
typedef boost::shared_ptr< ::autoware_msgs::ConfigPedestrianKf const> ConfigPedestrianKfConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator1> & lhs, const ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> >
{
  ...
  static const char* value(const ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x35fb5980cbba7f23ULL;
  static const uint64_t static_value2 = 0x7457ede929c58aa9ULL;
};

template<class ContainerAllocator>
struct DataType< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_msgs::ConfigPedestrianKf_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // AUTOWARE_MSGS_MESSAGE_CONFIGPEDESTRIANKF_H
