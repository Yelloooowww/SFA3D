// Generated by gencpp from file autoware_msgs/ConfigPoints2Polygon.msg
// DO NOT EDIT!


#ifndef AUTOWARE_MSGS_MESSAGE_CONFIGPOINTS2POLYGON_H
#define AUTOWARE_MSGS_MESSAGE_CONFIGPOINTS2POLYGON_H
...
struct ConfigPoints2Polygon_
{
  ...
  typedef boost::shared_ptr< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> const> ConstPtr;

}; // struct ConfigPoints2Polygon_

typedef ::autoware_msgs::ConfigPoints2Polygon_<std::allocator<void> > ConfigPoints2Polygon;

typedef boost::shared_ptr< ::autoware_msgs::ConfigPoints2Polygon > ConfigPoints2PolygonPtr;
typedef boost::shared_ptr< ::autoware_msgs::ConfigPoints2Polygon const> ConfigPoints2PolygonConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator1> & lhs, const ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> >
{
  ...
  static const char* value(const ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9b14a69dff1a04a7ULL;
  static const uint64_t static_value2 = 0x36a3b125792a41bfULL;
};

template<class ContainerAllocator>
struct DataType< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::autoware_msgs::ConfigPoints2Polygon_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // AUTOWARE_MSGS_MESSAGE_CONFIGPOINTS2POLYGON_H
